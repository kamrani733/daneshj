...
export const MOCK_PUBLIC_PANEL: PublicPanelProfile = {
  ...
  serviceCatalog: {
    ...
    discounts: [
      ...
      },
      {
        ...
        title: 'عنوان تخفیف',
        businessName: 'عنوان کسب و کار ارایه دهنده تخفیف',
        imageSrc: '/images/placeholders/card-4.png',
  ...
  otherInfo: {
    resume: {
      fileName: 'saeed_resume.pdf',
      sizeLabel: '۲.۳ مگابایت',
      updatedAt: '۱۴۰۳/۱۲',
      href: '#',
      previewHref: '#',
    },
    portfolio: [
      {
        id: 'p1',
        title: 'طراحی اپ سفر',
        description: 'UI/UX برای برنامه‌ریزی سفر',
        imageSrc: '/images/public-panel/portfolio-travel.png',
      },
      {
        id: 'p2',
        title: 'وبسایت فروشگاهی',
        description: 'فرانت‌اند با React',
        imageSrc: '/images/public-panel/portfolio-shop.png',
      },
      {
        id: 'p3',
        title: 'پوستر رویداد دانشگاه',
        description: 'طراحی گرافیک و تایپوگرافی',
        imageSrc: '/images/public-panel/portfolio-poster.png',
      },
    ],
    certificates: [
      {
        id: 'c1',
        title: 'گواهی پایتون پیشرفته',
        issuer: 'مکتب‌خونه',
        issuedAt: '۱۴۰۳/۰۵/۱۰',
        href: '#',
      },
